...
function Card(props, platform = "samrat leeto"){{/*this is good approach*/}
    console.log(props.anotherArr.surname)
    return(
<div class="bg-neutral-primary-soft block max-w-sm border border-default rounded-base shadow-xs">
    ...
    <div class="p-6 text-center">
        <span class="inline-flex items-center bg-brand-softer border border-brand-subtle text-fg-brand-strong text-xs font-medium px-1.5 py-0.5 rounded-sm">
            ...
            {props.platform || "facebook"} {/* this is okayish apprtroach */}
            
        </span>
        <a href="#">
            <h5 class="mt-3 mb-6 text-2xl font-semibold tracking-tight text-heading">{props.anotherArr.name}-{props.anotherArr.surname}{props.anotherObj[2]}</h5>
        </a>
